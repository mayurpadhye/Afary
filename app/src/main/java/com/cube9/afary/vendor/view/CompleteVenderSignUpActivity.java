...
public class CompleteVenderSignUpActivity extends AppCompatActivity {
                    ...
                    try {
                        ...
                        if (status.equals("1")) {
                            ...
                            ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>
                                    (CompleteVenderSignUpActivity.this, android.R.layout.simple_spinner_item,
    ...
    public void validation() {
        if (sp_state.getSelectedItem().toString().equals(getResources().getString(R.string.select_state))) {
            CustomUtils.showToast(getResources().getString(R.string.please_select_state), CompleteVenderSignUpActivity.this, MDToast.TYPE_ERROR);
            return;
        } else if (sp_state.getSelectedItem().toString().equals(getResources().getString(R.string.select_city))) {
            CustomUtils.showToast(getResources().getString(R.string.please_select_city), CompleteVenderSignUpActivity.this, MDToast.TYPE_ERROR);
            return;
            ...
            CustomUtils.showToast(getResources().getString(R.string.please_select_security_question), CompleteVenderSignUpActivity.this, MDToast.TYPE_ERROR);
            return;
